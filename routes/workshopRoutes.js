...
router.post("/", uploadSingle("coverImage"), workshopController.createWorkshop);

// Update a workshop with optional new cover image
router.put(
  "/:workshopId",
